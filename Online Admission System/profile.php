...
{	
	...
	echo "<center>Welcome reg I D ".$_SESSION['valid']. " &nbsp;&nbsp;&nbsp;! </center>";
	
	$result = mysql_query("select * from upload",$conn);
	$result2 = mysql_query("select * from upload where regId=".$_SESSION['valid']. " ",$conn);
	echo "<br><br><br>";
	...
	$result2 = mysql_query("select * from pdetails where regId=".$_SESSION['valid']. " ",$conn);
	$row = mysql_fetch_assoc($result2);
	...
	$result2 = mysql_query("select * from edudetails where regId=".$_SESSION['valid']. " ",$conn);
	$row = mysql_fetch_assoc($result2);
